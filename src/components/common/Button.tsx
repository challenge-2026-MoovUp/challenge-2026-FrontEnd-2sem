...
const variantClasses = {
    ...
    'cta-primary': `${baseClass} m-4 rounded-[50px] bg-gradiente-aurora px-8 py-4 text-[1.3rem] font-medium tracking-[0.08em] text-mist [transition:all_.5s_ease] hover:-translate-y-0.5 hover:cursor-pointer hover:shadow-[0_8px_36px_var(--color-aurora-35)]`,
