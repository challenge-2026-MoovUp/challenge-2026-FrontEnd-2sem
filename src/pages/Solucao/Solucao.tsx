...
export default function Solucao() {
    return (
        <section className="mx-auto mb-32 mt-[clamp(4rem,8vw,8rem)] grid w-full max-w-[1120px] gap-[28px] px-[3.2rem]" aria-labelledby="solution-title">
            <div className="grid grid-cols-[minmax(0,1fr)_minmax(320px,0.78fr)] items-center gap-x-[4.4rem] gap-y-[2.8rem]">
                <div className="relative col-start-1 row-start-1 m-0 flex w-full flex-col items-start after:mt-[2.2rem] after:block after:h-[2px] after:w-[12rem] after:bg-gradiente-aurora after:content-['']">
                ...
                <div className="col-start-1 row-start-2 grid max-w-[900px] gap-[18px]">
                ...
                <figure className="col-start-2 row-span-2 row-start-1 flex items-center justify-center self-stretch overflow-hidden rounded-[20px] border border-border-mid bg-[linear-gradient(145deg,var(--color-dusk-mid-88),var(--color-void-86)),var(--color-dusk)] shadow-[0_24px_70px_var(--color-black-26)]">
                    <img src={MapaMoovUp} alt="Mapa de metrô da MoovUp" className="block h-auto max-h-full w-full object-contain" />
                </figure>
            </div>

            <section className="grid grid-cols-[minmax(0,0.72fr)_minmax(320px,1fr)] items-center gap-[26px] overflow-hidden rounded-[20px] border border-border bg-[linear-gradient(145deg,var(--color-dusk-mid-88),var(--color-void-86)),var(--color-dusk)] p-[30px] shadow-[0_24px_70px_var(--color-black-26)]" aria-labelledby="solution-pitch-title">
                ...
                <iframe
                    ...
                    src="https://www.youtube.com/embed/S8ajD2LQ3Q0?si=Be8zprYWXTN0FlWQ"
            ...
            <div className="grid gap-[14px] rounded-[20px] border border-border bg-dusk p-[30px]">
            ...
            <div className="grid grid-cols-3 gap-4" aria-label="Principais recursos da solução">
                <article className="flex min-h-[260px] flex-col gap-[14px] rounded-xl border border-border bg-void p-7 transition-[background-color,border-color,transform] duration-300 ease-in-out hover:-translate-y-1 hover:border-border-mid hover:bg-aurora-glow">
