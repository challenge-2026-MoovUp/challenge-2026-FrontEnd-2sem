            ...
            <section className="solution__overview" aria-labelledby="solution-title">
                <div className="solution__hero">
                    ...
                    <figure className="solution__visual">
                        <img src="../assets/images/mapa-moovUp.jpg" alt="Mapa de metrô da MoovUp" className="solution-img" />
                    </figure>
                </div>
                ...
                <section className="solution__pitch" aria-labelledby="solution-pitch-title">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/S8ajD2LQ3Q0?si=Be8zprYWXTN0FlWQ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </section>
